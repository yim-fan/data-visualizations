...
wtfl1 <- summarize(group_by(wtfl, wind_speed_level = equal.count(wind_speed)), ave_dep_delay = mean(dep_delay, na.rm = TRUE),n = n())
ggplot(wtfl1, aes(wind_speed_level,ave_dep_delay)) + geom_point() + geom_smooth()
```
...
ggplot(wtfl1, aes(wind_speed_level,ave_dep_delay, size = n)) + geom_point(alpha = 0.8) + geom_smooth()
```
