...
## Steam games sales and popularity investment
  ...
  In this project, I'm going to take two dataset from steam: One is the game sale data set that provides games available on steam in 2016, game category, the game producers, game sales in different continent, as well as expert ratings on the game. The other one is about users' status: users' ID, game name, game status(purchased or played) and hours spend on the game. 

  I'm going to use informations from both data set to sovle questions below:
